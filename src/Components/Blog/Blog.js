    ...
    return (
        <div className='text-justify px-20'>
           <h2 className="text-3xl text-secondary mb-12"> Latest blogs</h2>
            <p className='text-xl'>How will you improve the performance of a React Application?</p>
            ...
            <br />
            <p className='text-xl'>What are the different ways to manage a state in a React application?</p>
            ...
            <br />
            <p className='text-xl'> What is a unit test? Why should write unit tests?</p>
            <br />
            ...
            <br />
            <p className='text-xl'>Why we do not set the state directly in React.</p>
